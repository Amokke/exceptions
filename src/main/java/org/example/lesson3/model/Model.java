package org.example.lesson3.model;

import org.example.lesson3.data.Data;
...
public class Model {
    ...
    public Model(String input) {
        ...
        try {
            ...
            System.out.println("ОШИБКА проверьте ->" + array + "\n");
        }
    }

    private void write() {
        String path = "C:\\tmp\\" + data.getLastName().toLowerCase() + ".txt";
